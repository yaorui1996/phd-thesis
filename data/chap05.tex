...
\begin{figure}
    ...
    {\includegraphics[width=0.4\linewidth]{fig_5_fit_the_electrical_potential_coefficient_for_each_electrode_image.pdf}}
    \subcaptionbox{\label{fig:fit_the_electrical_potential_coefficient_for_each_electrode_1}}
    {\includegraphics[width=0.4\linewidth]{fig_5_fit_the_electrical_potential_coefficient_for_each_electrode_1.pdf}}
    \subcaptionbox{\label{fig:fit_the_electrical_potential_coefficient_for_each_electrode_2}}
    {\includegraphics[width=0.4\linewidth]{fig_5_fit_the_electrical_potential_coefficient_for_each_electrode_2.pdf}}
    \subcaptionbox{\label{fig:fit_the_electrical_potential_coefficient_for_each_electrode_3}}
    {\includegraphics[width=0.4\linewidth]{fig_5_fit_the_electrical_potential_coefficient_for_each_electrode_3.pdf}}
    \subcaptionbox{\label{fig:fit_the_electrical_potential_coefficient_for_each_electrode_4}}
    {\includegraphics[width=0.4\linewidth]{fig_5_fit_the_electrical_potential_coefficient_for_each_electrode_4.pdf}}
    \subcaptionbox{\label{fig:fit_the_electrical_potential_coefficient_for_each_electrode_5}}
    {\includegraphics[width=0.4\linewidth]{fig_5_fit_the_electrical_potential_coefficient_for_each_electrode_5.pdf}}
