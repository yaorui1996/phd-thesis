...
Then we can extend it to the second order. We can simplify $\bar{x}(t)=c_0+2 \Re\left(c_{-1} e^{-i \omega_m t}\right)$. If we replace it back into Eq.~\ref{eq:parametric_excitation}, we can easily find the answer for the second order,
